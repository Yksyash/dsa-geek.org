...
function SignupPage(){
  ...
  return(
    ...
    <div class='tw-w-1/2 tw-h-2/3 sm:tw-h-2/3 sm:tw-w-2/5 md:tw-w-1/3 lg:tw-w-1/4 sm:tw-h-4/5 tw-border tw-border-gray-500 tw-rounded-lg'>
      ...
      <div class=' tw-flex tw-flex-col tw-my-2 tw-items-center tw-gap-2 tw-mt-4'>
        ...
        <input class='tw-border-gray-500 tw-border tw-mt-4 tw-rounded-lg tw-font-light tw-p-2'  type="text" placeholder='UserName' onChange={(e) => setUsername(e.target.value)} />
        ...
        <h3>Existing User?<Button  variant="text"  onClick={() => navigate('/user/login')}>Login</Button></h3>
